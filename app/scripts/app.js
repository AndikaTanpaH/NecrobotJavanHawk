(function() {
    ...
    $(function() {
        ...
        $("#sortByNm").click(() => global.map.displayPokemonList(null, "name"));
        $("#sortByHp").click(() => global.map.displayPokemonList(null, "zhpmax"));

        $("#sortBypokemonId, #sortBycp, #sortByiv, #sortByNm, #sortByHp").click( function() {
